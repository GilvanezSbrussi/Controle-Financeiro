...
// Serve clientes.html e clientes.js da pasta license-admin
app.get('/clientes.html', (req, res) => {
  res.sendFile(path.join(__dirname, 'clientes.html'));
});

app.get('/clientes.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'clientes.js'));
});
