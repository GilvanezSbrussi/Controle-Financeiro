...
const PLANOS = {
  ...
  mensal:     { nome: "Mensal",     dias: 30,  preco: 14.90 },
  trimestral: { nome: "Trimestral", dias: 90,  preco: 34.90 },
  semestral:  { nome: "Semestral",  dias: 180, preco: 59.90 },
  anual:      { nome: "Anual",      dias: 365, preco: 99.90 },
};
  ...
  async (req, res) => {
    ...
    try {
      ...
      const preference = {
        ...
        metadata: { deviceId, plano, holder: holder || "Cliente", document: document || "", email: email || null },
        back_urls: {
